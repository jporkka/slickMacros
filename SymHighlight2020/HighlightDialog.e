...
_form Highlights_form {
   ...
   _command_button button_Close {
      ...
      p_x=780;
      p_y=1140;
      p_eventtab=Highlights_form.ctlcommand1;
   }
   _tree_view ctl_tree {
...
{
    if (s_form1_p != 0) {
        if (_iswindow_valid(s_form1_p) && s_form1_p.p_name=='Highlights_form') {
            return s_form1_p;
        } else {
            dlgsay("No form 2!");
            s_form1_p = 0;
...
void Highlights_form.on_resize()
{
